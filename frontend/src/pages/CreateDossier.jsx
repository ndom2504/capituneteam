...
export default function CreateDossier() {
  ...
  const nationaliteOptions = [
    ...
    ['congolaise_brazzaville', 'Congolaise - Congo Brazzaville'],
  ...
  const commonFields = [
    ...
    { name: 'pays_residence', label: 'Pays de résidence actuel', type: 'select', required: true, options: paysResidenceOptions },
